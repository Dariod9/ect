...
public class Mt2_89288 {
	...
	/*	do{			//Validar numero de alunos da turma
		...
		for(int i=0; i<=20;i++){
			...
			valor=validarNota(); //Introdução de cada nota				
			cont++;
				}
		
		int a_notas[] = new int[cont]; //Array correspondente ao conjunto de notas
		...
		escreveFicheiro(a_notas,cont,min,max,media,moda);
	}
