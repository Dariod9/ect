...
public class Test {
		  ...
		  public static Alimento randAlimento() {
			  ...
			  default:
				  case 0:     return new Carne(TipoCarne.FRANGO, 22.3, 345.3, 300);
				  case 1:     return new Peixe(TipoPeixe.Congelado, 31.3, 25.3, 200);
				  case 2:     return new Legume("Couve Flor", 21.3, 22.4, 150);
				  case 3:     return new Cereal("Milho", 19.3, 32.4, 110);
				  }
			  }
		  ...
		  public static Prato randPrato(int i) {
			  ...
			  default:
				  case 0:     return new Prato("Prato N." + i);
				  case 1:     return new PratoVegetariano("Prato N." + i + " (Vegetariano)");
				  case 2:     return new PratoDieta("Prato N." + i + " (Dieta)", 90.8);
				  }
	  }  
}
