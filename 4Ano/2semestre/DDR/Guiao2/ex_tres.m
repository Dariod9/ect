...
[results results2] = simulator2(lambda,30,n,1000,W(3),R,'movies.txt');
...
%%somas esses todos e fazer regra de 3 simples para só tendo 78 (cada um desses números de servers é mais baixo)