...
#print(z.find_predecessors('vertebrado','socrates'))
#print(z.find_predecessors('vertebrado','filosofo'))
#print(z.predecessor_path('vertebrado','socrates'))
#print(z.query_down('socrates','altura'))
#print(z.show_query_result())
#print(z.query_induce())
